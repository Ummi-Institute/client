...
const ReplayIcon: FC<IconProps> = (props) => {
    return (
        <svg
            height="200px"
            width="200px"
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <g transform="translate(0 -562.36)">
                    ...
                    <g>
                        ...
                        <g>
                            {' '}
                            <polygon points="128.6,656.912 128.6,656.912 128.6,656.912 "></polygon>{' '}
                            <path d="M115.5,671.112v97.7c0,10.5,10.5,17.3,19.9,12.6l98.2-48.8c10-5.3,10-20,0-25.2l-98.2-48.8c-2.1-1.1-4.2-1.7-6.8-1.7 C121.3,657.412,115.5,663.212,115.5,671.112z M143.3,693.712l52.5,26.3l-52.5,26.3V693.712z"></path>{' '}
